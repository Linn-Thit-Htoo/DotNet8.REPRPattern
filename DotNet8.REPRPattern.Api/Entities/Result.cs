using DotNet8.REPRPattern.Api.Enums;

namespace DotNet8.REPRPattern.Api.Entities
{
    public class Result<T>
    {
        ...
        {
            return new Result<T> { Message = message, IsSuccess = true, StatusCode = EnumStatusCode.Success };
        }

        public static Result<T> Success(T data, string message = "Success.")
        {
            return new Result<T> { Data = data, Message = message, IsSuccess = true, StatusCode = EnumStatusCode.Success };
        }
